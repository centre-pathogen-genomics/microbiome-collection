...
Run the relevant script specifying the output directory (each step will identify it's own input files based on outputs generated by previous steps)
```bash
...
|7|[Prokka](https://github.com/eggnogdb/eggnog-mapper)|Additional genome annotation|
|8|[antiSMASH](https://github.com/antismash/antismash)|Identify secondary metabolite biosysthetic gene clusters|
